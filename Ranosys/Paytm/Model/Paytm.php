...
use Ranosys\Paytm\Helper\Data as DataHelper;
...
class Paytm extends \Magento\Payment\Model\Method\AbstractMethod {
    ...
    protected $helper;
    protected $_supportedCurrencyCodes = array('INR'); //supported currency code
